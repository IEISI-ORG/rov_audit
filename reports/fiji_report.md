    ...
    ------------------------------------------------------------
    SECURE NETWORKS:         4 (19.0%) -> Protects 18.2% of Traffic
    VULNERABLE NETWORKS:     7 (33.3%) -> Exposes  0.0% of Traffic
    ...
    AS45355  | SECURE (Full Coverage)         | 2        | 1%     | Digicel Fiji Limited
    AS4638   | Unverified (Transit/Peer?)     | 2        | 87%    | Telecom Fiji Limited
    ...
    AS142245 | STUB: SECURE (Full Coverage)   | 0        | -      | Kastle (Fiji) Pte Ltd
    ...
    ====================================================================================================
    [*] Analyzing Upstream Supply Chain for 21 networks...
        - Analyzed connectivity for 20 networks.
    ...
    #6   | AS7575   | 2          | SECURE (Full Coverage)         | Australian Academic and Research Network
    #7   | AS38442  | 2          | PARTIAL (Mixed Feeds)          | Vodafone Fiji Limited
    ...
    #11  | AS132528 | 1          | STUB: VULNERABLE               | DIGICEL (AUS) PTY LTD
    ...
    AS135647 | 0        | 1/1    | Airports Fiji Limited
