    ...
    AS4134   | CORE: UNPROTECTED              | 378      | 0%     | China Telecom Backbone
    AS24429  | PARTIAL (Mixed Feeds)          | 166      | 1%     | Alibaba Cloud
    AS139589 | PARTIAL (Mixed Feeds)          | 146      | -      | GTDev Network
    AS4837   | CORE: UNPROTECTED              | 100      | 0%     | China Unicom Backbone
    AS139317 | SECURE (Full Coverage)         | 81       | -      | Ningbo Dahuamao Information Technology C
    ...
    AS17621  | Unverified (Transit/Peer?)     | 33       | 0%     | China Unicom Shanghai network
    ...
    #11  | AS53667  | 35         | SECURE (Active Local ROV)      | FranTech Solutions
    #12  | AS4812   | 35         | VULNERABLE (No Coverage)       | China Telecom Shanghai Province Network
    #13  | AS6939   | 34         | CORE: PROTECTED                | Hurricane Electric LLC
    #14  | AS44324  | 33         | PARTIAL (Mixed Feeds)          | MoeDove LLC
    #15  | AS56048  | 33         | Unverified (Transit/Peer?)     | China Mobile Group Beijing Company
    #16  | AS17621  | 29         | Unverified (Transit/Peer?)     | China Unicom Shanghai network
    #17  | AS34927  | 28         | SECURE (Full Coverage)         | iFog GmbH
    #18  | AS7720   | 24         | SECURE (Full Coverage)         | Skywolf Technology LLC
    #19  | AS24400  | 24         | Unverified (Transit/Peer?)     | Shanghai Mobile Communications Co.,Ltd.
    ...
    ASN      | Cone     | Feeds  | Name
    --------------------------------------------------------------------------------
    AS4134   | 378      | 0/0    | China Telecom Backbone
    AS4837   | 100      | 0/0    | China Unicom Backbone
    AS9808   | 60       | 0/0    | China Mobile Backbone
    AS4812   | 42       | 1/1    | China Telecom Shanghai Province Network
