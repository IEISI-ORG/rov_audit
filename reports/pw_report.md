    ...
    ------------------------------------------------------------
    SECURE (ACTIVE/PASSIVE):     2 (50.0%) -> Protects 0.0% of Traffic
    VULNERABLE NETWORKS:         2 (50.0%) -> Exposes  0.0% of Traffic

    ====================================================================================================
     THE PW CORE (Top 20 Networks)
    ====================================================================================================
    ASN      | Verdict                        | Cone     | APNIC% | Name
    ----------------------------------------------------------------------------------------------------
    AS214652 | STUB: PASSIVE (Clean Pipe)     | 0        | -      | ANQI CHEN
    AS17893  | STUB: PASSIVE (Clean Pipe)     | 0        | 0%     | Palau National Communications Corp.
    AS58932  | STUB: VULNERABLE               | 0        | 0%     | Palau Mobile Communications Inc.
    AS133897 | STUB: VULNERABLE               | 0        | 7%     | Palau Equipment Co. Inc.
    ...
    ----------------------------------------------------------------------------------------------------
    #1   | AS3605   | 2          | PARTIAL: VULNERABLE (Mixed)    | Guam Cablevision, LLC.
    ...
    #5   | AS24545  | 1          | STUB: VULNERABLE               | 8/F.,Sino Favour Centre ,1 OnYip Street 
