    ...
    ------------------------------------------------------------
    SECURE NETWORKS:         2 ( 5.1%) -> Protects 0.0% of Traffic
    VULNERABLE NETWORKS:    25 (64.1%) -> Exposes  0.0% of Traffic
    ...
    ----------------------------------------------------------------------------------------------------
    AS17828  | PARTIAL (Mixed Feeds)          | 17       | 7%     | PNG DATACO LTD
    AS58460  | PARTIAL (Mixed Feeds)          | 5        | 3%     | Digicel (PNG) Ltd
    AS138506 | STUB: VULNERABLE               | 0        | -      | PNG Nambawan Trophy Ltd
    AS153781 | STUB: VULNERABLE               | 0        | -      | Wintop Investment Limited
    AS153621 | NOT ROUTED                     | 0        | -      | GIT LIMITED
    ...
    AS136587 | STUB: VULNERABLE               | 0        | -      | PNG DATACO LIMITED
    ...
    AS151398 | STUB: SECURE (Full Coverage)   | 0        | -      | Credit Corporation (PNG) Limited
    ...
    #2   | AS58460  | 4          | PARTIAL (Mixed Feeds)          | Digicel (PNG) Ltd
    #3   | AS6939   | 3          | CORE: PROTECTED                | Hurricane Electric LLC
    #4   | AS4637   | 3          | CORE: PROTECTED                | Telstra Global
    ...
    #7   | AS13335  | 2          | SECURE (Full Coverage)         | Cloudflare, Inc.
    #8   | AS12684  | 2          | PARTIAL (Mixed Feeds)          | SES ASTRA S.A.
    ...
    #14  | AS38442  | 1          | PARTIAL (Mixed Feeds)          | Vodafone Fiji Limited
    #15  | AS55792  | 1          | STUB: VULNERABLE               | Datec-PNG
    #16  | AS45411  | 1          | STUB: VULNERABLE               | APCS Australia
    #17  | AS139898 | 1          | STUB: VULNERABLE               | Digitec Communications Limited
