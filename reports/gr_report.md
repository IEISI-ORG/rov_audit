    ...
    ====================================================================================================
    Total Networks:      259
    Total Cone Gravity:  587
    ------------------------------------------------------------
    SECURE (ACTIVE/PASSIVE):   118 (45.6%) -> Protects 79.9% of Traffic
    VULNERABLE NETWORKS:        96 (37.1%) -> Exposes  2.6% of Traffic
    ...
    ----------------------------------------------------------------------------------------------------
    AS8280   | ACTIVE LOCAL ROV               | 344      | 98%    | SYNAPSECOM S.A. Provider of Telecommunic
    AS6799   | Unverified (Transit/Peer?)     | 39       | 99%    | Ote SA (Hellenic Telecommunications Orga
    ...
    AS3329   | ACTIVE LOCAL ROV               | 28       | 99%    | Vodafone Greece
    AS199081 | PARTIAL: VULNERABLE (Mixed)    | 26       | 100%   | Lancom Ltd.
    AS198477 | PASSIVE (Clean Pipe)           | 25       | -      | TI SPARKLE GREECE SA
    AS56910  | PASSIVE (Clean Pipe)           | 19       | -      | Digital Realty Hellas Single Member S.A
    AS25472  | PASSIVE (Clean Pipe)           | 19       | 0%     | Nova Telecommunications & Media Single M
    AS206735 | REGRESSED                      | 13       | 0%     | Novelcomm LP
    ...
    #12  | AS206735 | 12         | REGRESSED                      | Novelcomm LP
    ...
    #20  | AS9002   | 4          | PARTIAL: VULNERABLE (Mixed)    | RETN Limited
