    ...
    ----------------------------------------------------------------------------------------------------
    AS8280   | ACTIVE LOCAL ROV               | 342      | 100%   | SYNAPSECOM S.A. Provider of Telecommunic
    AS6799   | ACTIVE (Atlas Verified)        | 38       | 99%    | Ote SA (Hellenic Telecommunications Orga
    AS1241   | PARTIAL: VULNERABLE (Mixed)    | 32       | 99%    | Nova Telecommunications & Media Single M
    AS3329   | PARTIAL: VULNERABLE (Mixed)    | 30       | 99%    | Vodafone Greece
    ...
    ----------------------------------------------------------------------------------------------------
    #1   | AS1241   | 30         | PARTIAL: VULNERABLE (Mixed)    | Nova Telecommunications & Media Single M
    #2   | AS6799   | 30         | ACTIVE (Atlas Verified)        | Ote SA (Hellenic Telecommunications Orga
    #3   | AS174    | 29         | CORE: ACTIVE PROTECTOR         | Cogent Communications, LLC
    #4   | AS5408   | 28         | ACTIVE LOCAL ROV               | National Infrastructures for Research an
    #5   | AS3329   | 24         | PARTIAL: VULNERABLE (Mixed)    | Vodafone Greece
    #6   | AS198477 | 22         | PASSIVE (Clean Pipe)           | TI SPARKLE GREECE SA
    #7   | AS199081 | 21         | PARTIAL: VULNERABLE (Mixed)    | Lancom Ltd.
    #8   | AS25472  | 20         | PARTIAL: VULNERABLE (Mixed)    | Nova Telecommunications & Media Single M
    #9   | AS6939   | 18         | CORE: ACTIVE PROTECTOR         | Hurricane Electric LLC
    #10  | AS6762   | 17         | CORE: ACTIVE PROTECTOR         | Telecom Italia Sparkle (Seabone)
    #11  | AS56910  | 17         | PARTIAL: VULNERABLE (Mixed)    | Digital Realty Hellas Single Member S.A
    #12  | AS206735 | 12         | PARTIAL: VULNERABLE (Mixed)    | Novelcomm LP
    #13  | AS8280   | 10         | ACTIVE LOCAL ROV               | SYNAPSECOM S.A. Provider of Telecommunic
    ...
    #18  | AS57463  | 5          | PASSIVE (Clean Pipe)           | NetIX Communications JSC
    #19  | AS13335  | 4          | ACTIVE LOCAL ROV (Hardcoded)   | Cloudflare, Inc.
    #20  | AS9002   | 4          | Unverified (Transit/Peer?)     | RETN Limited
