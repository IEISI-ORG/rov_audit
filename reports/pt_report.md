    ...
    ----------------------------------------------------------------------------------------------------
    AS6424   | PASSIVE (Clean Pipe)           | 145      | -      | EDGOO NETWORKS
    AS2860   | ACTIVE UNSTABLE                | 44       | 99%    | NOS COMUNICACOES, S.A.
    AS15525  | VULNERABLE STABLE              | 23       | 2%     | MEO - SERVICOS DE COMUNICACOES E MULTIME
    AS8657   | PASSIVE (Clean Pipe)           | 21       | -      | MEO International Backbone
    AS9186   | PASSIVE (Clean Pipe)           | 11       | 1%     | ONITELECOM - INFOCOMUNICACOES, S.A.
    AS12353  | ACTIVE UNSTABLE                | 10       | 99%    | Vodafone Portugal - Communicacoes Pessoa
    ...
    ----------------------------------------------------------------------------------------------------
    #1   | AS2860   | 34         | ACTIVE UNSTABLE                | NOS COMUNICACOES, S.A.
    #2   | AS15525  | 20         | VULNERABLE STABLE              | MEO - SERVICOS DE COMUNICACOES E MULTIME
    #3   | AS174    | 18         | CORE: ACTIVE PROTECTOR         | Cogent Communications, LLC
    #4   | AS12353  | 11         | ACTIVE UNSTABLE                | Vodafone Portugal - Communicacoes Pessoa
    ...
    #15  | AS6762   | 3          | CORE: ACTIVE PROTECTOR         | Telecom Italia Sparkle (Seabone)
    #16  | AS1299   | 3          | CORE: ACTIVE PROTECTOR         | Arelion (fka. Telia Carrier)
    #17  | AS8657   | 3          | PASSIVE (Clean Pipe)           | MEO International Backbone
