    ...
    ====================================================================================================
    Total Networks:      208
    Total Cone Gravity:  171
    ------------------------------------------------------------
    SECURE (ACTIVE/PASSIVE):     2 ( 1.0%) -> Protects 0.0% of Traffic
    VULNERABLE NETWORKS:       138 (66.3%) -> Exposes  32.2% of Traffic
    ...
    ----------------------------------------------------------------------------------------------------
    AS17501  | Unverified (Transit/Peer?)     | 34       | 24%    | WorldLink Communications Pvt Ltd
    AS45274  | PARTIAL: VULNERABLE (Mixed)    | 32       | -      | WorldLink International Transit Services
    AS4007   | VULNERABLE                     | 32       | 22%    | Subisu Cablenet (Pvt) Ltd, Baluwatar, Ka
    AS45650  | PARTIAL: VULNERABLE (Mixed)    | 24       | 22%    | VIA NET COMMUNICATION LTD.
    AS141047 | Unverified (Transit/Peer?)     | 11       | 14%    | Nepal Digital Service Pvt. Ltd.
    AS139922 | VULNERABLE                     | 10       | 22%    | DISH MEDIA NETWORK PUBLIC LIMITED
    AS148979 | Unverified (Transit/Peer?)     | 9        | -      | Fiberworld Communication Pvt. Ltd.
    AS58504  | Unverified (Transit/Peer?)     | 6        | 22%    | TECHMINDS NETWORKS PVT. LTD.
    AS151396 | VULNERABLE                     | 5        | 20%    | Sajilo Net Pvt Ltd
    ...
    #12  | AS38565  | 4          | VULNERABLE                     | Ncell Pvt. Ltd.
    #13  | AS45157  | 4          | NOT ROUTED                     | Mercantile International Transit Service
    ...
    #19  | AS55915  | 2          | STUB: VULNERABLE               | Classic Tech Pvt. Ltd.
