    ...
    #2   | AS24835  | 32         | SECURE (Full Coverage)         | Vodafone Egypt
    #3   | AS24863  | 16         | SECURE (Full Coverage)         | Link Egypt (Link.NET)
    #4   | AS36992  | 11         | SECURE (Full Coverage)         | Etisalat Egypt
    #5   | AS20928  | 9          | SECURE (Full Coverage)         | The Noor Group
    #6   | AS5511   | 2          | CORE: PROTECTED                | Orange S.A.
    #7   | AS6762   | 2          | CORE: PROTECTED                | Telecom Italia Sparkle (Seabone)
    #8   | AS3257   | 2          | CORE: PROTECTED                | GTT Communications Inc.
    #9   | AS3356   | 2          | CORE: PROTECTED                | Lumen (Level 3)
    #10  | AS8697   | 1          | PARTIAL (Mixed Feeds)          | Jordan Telecommunications PSC
    #11  | AS174    | 1          | CORE: PROTECTED                | Cogent Communications, LLC
    #12  | AS15412  | 1          | SECURE (Active Local ROV)      | Flag Telecom UK Limited
    #13  | AS1273   | 1          | CORE: PROTECTED                | Vodafone Group PLC
    #14  | AS2914   | 1          | CORE: PROTECTED                | NTT America, Inc.
    ...
    ====================================================================================================
     TOP VULNERABLE EG NETWORKS
    ====================================================================================================
    ASN      | Cone     | Feeds  | Name
    --------------------------------------------------------------------------------
    AS328299 | 0        | 1/2    | Attijariwafa Bank Egypt S.A.E
    AS328405 | 0        | 1/2    | Link Datacenter For Data Circulation
    AS328052 | 0        | 1/1    | Orascom Construction
    AS328067 | 0        | 1/1    | E.G.I.T. for Technology Services
