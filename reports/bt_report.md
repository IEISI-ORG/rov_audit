    ...
    ------------------------------------------------------------
    SECURE (ACTIVE/PASSIVE):     6 (14.6%) -> Protects 100.0% of Traffic
    VULNERABLE NETWORKS:        19 (46.3%) -> Exposes  0.0% of Traffic
    ...
    ----------------------------------------------------------------------------------------------------
    #1   | AS38740  | 15         | PASSIVE (Clean Pipe)           | Tashi InfoComm Limited
    #2   | AS17660  | 10         | PASSIVE (Clean Pipe)           | DrukNet ISP
    #3   | AS18024  | 6          | ACTIVE (Atlas Verified)        | Bhutan Telecom Ltd
    #4   | AS6453   | 3          | CORE: ACTIVE PROTECTOR         | TATA Communications (America) Inc
    #5   | AS2914   | 2          | CORE: ACTIVE PROTECTOR         | NTT America, Inc.
    #6   | AS136039 | 2          | STUB: VULNERABLE STABLE        | NANO, Bhutan
