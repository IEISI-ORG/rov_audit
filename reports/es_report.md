    ...
    ----------------------------------------------------------------------------------------------------
    AS12956  | CORE: ACTIVE PROTECTOR         | 61269    | -      | Telxius (Telefonica Global)
    AS29119  | PARTIAL: VULNERABLE (Mixed)    | 314      | 42%    | AIRE NETWORKS DEL MEDITERRANEO SL UNIPER
    ...
    ----------------------------------------------------------------------------------------------------
    #1   | AS29119  | 187        | PARTIAL: VULNERABLE (Mixed)    | AIRE NETWORKS DEL MEDITERRANEO SL UNIPER
    #2   | AS174    | 154        | CORE: ACTIVE PROTECTOR         | Cogent Communications, LLC
    #3   | AS12357  | 90         | VULNERABLE                     | VODAFONE ESPANA S.A.U.
    #4   | AS3352   | 87         | ACTIVE LOCAL ROV               | TELEFONICA DE ESPANA S.A.U.
    ...
    #8   | AS12541  | 53         | PASSIVE (Clean Pipe)           | LYNTIA NETWORKS S.A.
    #9   | AS35699  | 51         | PASSIVE (Clean Pipe)           | Adamo Telecom Iberia S.A.
