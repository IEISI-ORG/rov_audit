    ...
    ------------------------------------------------------------
    SECURE NETWORKS:       106 (47.3%) -> Protects 83.9% of Traffic
    VULNERABLE NETWORKS:   106 (47.3%) -> Exposes  0.0% of Traffic
    ...
    ====================================================================================================
    [*] Analyzing Upstream Supply Chain for 224 networks...
        - Analyzed connectivity for 224 networks.
    Rank | Upstream | Dependents | Global Status                  | Name
    ----------------------------------------------------------------------------------------------------
    #1   | AS1241   | 30         | SECURE (Active Local ROV)      | Nova Telecommunications & Media Single M
    #2   | AS6799   | 30         | Unverified (Transit/Peer?)     | Ote SA (Hellenic Telecommunications Orga
    #3   | AS174    | 28         | CORE: PROTECTED                | Cogent Communications, LLC
    #4   | AS5408   | 28         | SECURE (Full Coverage)         | National Infrastructures for Research an
    #5   | AS3329   | 23         | SECURE (Full Coverage)         | Vodafone Greece
    ...
    #9   | AS56910  | 18         | SECURE (Full Coverage)         | Digital Realty Hellas Single Member S.A
    #10  | AS6762   | 17         | CORE: PROTECTED                | Telecom Italia Sparkle (Seabone)
    #11  | AS6939   | 17         | CORE: PROTECTED                | Hurricane Electric LLC
    #12  | AS206735 | 12         | PARTIAL (Mixed Feeds)          | Novelcomm LP
    #13  | AS8280   | 10         | SECURE (Active Local ROV)      | SYNAPSECOM S.A. Provider of Telecommunic
    #14  | AS3356   | 8          | CORE: PROTECTED                | Lumen (Level 3)
    #15  | AS3491   | 6          | CORE: PROTECTED                | PCCW Global, Inc.
    #16  | AS32787  | 6          | SECURE (Full Coverage)         | Akamai (Prolexic)
    #17  | AS1299   | 5          | CORE: PROTECTED                | Arelion (fka. Telia Carrier)
    #18  | AS57463  | 5          | PARTIAL (Mixed Feeds)          | NetIX Communications JSC
    #19  | AS9002   | 4          | SECURE (Full Coverage)         | RETN Limited
    #20  | AS29632  | 4          | SECURE (Full Coverage)         | Netassist International EOOD

    ====================================================================================================
     TOP VULNERABLE GR NETWORKS
    ====================================================================================================
    ASN      | Cone     | Feeds  | Name
    --------------------------------------------------------------------------------
